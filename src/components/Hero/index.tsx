          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.4]">
                  Create High-Quality Posts for Social Media{" "}
                  <span className="rounded-md px-2 py-1 dark:bg-dark">
                    Fast!
                  </span>
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-lg font-medium text-white sm:text-lg sm:leading-[1.5]">
                  Transform any web page or YouTube video into ready-to-publish
                  content for Twitter, Facebook, Reddit, and more.
                </p>
